...
class AccountServiceTest{
    ...
    // 테스트 진행중에 nullpoint가 잡히면 실제 진행되는 클래스에서 디버깅을 진행해보면 조금 예외가 발생하는 포인트를 캐치할 수 있을 것이다.
    @Test
    ...
    void deleteAccountSuccess(){
        ...
        // when
        AccountDto accountDto = accountService.deleteAccount(1L, "123456890");
